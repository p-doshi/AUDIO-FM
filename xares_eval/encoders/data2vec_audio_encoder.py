"""X-ARES encoder wrapper for Data2Vec-audio. See hubert_encoder.py for the
...
class Data2VecAudioXaresEncoder(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self._adapter = get_model_class("data2vec_audio")(device="cuda" if torch.cuda.is_available() else "cpu")
        self._adapter.load()
...
if __name__ == "__main__":
    ...
    encoder = Data2VecAudioXaresEncoder()
