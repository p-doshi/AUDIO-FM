"""X-ARES encoder wrapper for UniSpeech-SAT. See hubert_encoder.py for the
...
class UniSpeechSatXaresEncoder(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self._adapter = get_model_class("unispeech_sat")(device="cuda" if torch.cuda.is_available() else "cpu")
        self._adapter.load()
...
if __name__ == "__main__":
    ...
    encoder = UniSpeechSatXaresEncoder()
