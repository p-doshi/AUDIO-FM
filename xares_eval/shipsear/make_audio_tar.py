...
SCRATCH_ENV_ROOT = os.environ.get("XARES_ENV_ROOT", "/scratch/user/audio_comp/xares_env/env")
CLIPS_DIR = Path(os.environ.get("SHIPSEAR_CLIPS_DIR", "/scratch/user/audio_comp/shipsear_clips"))
