...
if __name__ == "__main__":
    ...
    parser.add_argument("--embeddings-augmented-dir", default="/scratch/user/audio_comp/embeddings_augmented")
    parser.add_argument("--embeddings-dir", default="/scratch/user/audio_comp/embeddings")
